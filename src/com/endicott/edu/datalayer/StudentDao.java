...
public class StudentDao {
    ...
    private static void testNotes() {
        ...
        StudentModel s1 = new StudentModel("Connor Frazier", 337714, 80, true, 7, "Standish", "Male", runId);
        StudentModel s2 = new StudentModel("Cam Bleck", 555555, 75, true, 9, "Winthrop", "Male", runId);
        ArrayList<StudentModel> students = new ArrayList<>();
        students.add(s1);
        students.add(s2);
        ...
        StudentModel s3 = new StudentModel("Joe Smith", 010101, 50, false, 0, "Marblehead", "Male", runId);
